export const speakers = [
{
    ...
    abstact: 'This talk will present Liquid Foundation Models (LFMs), Liquid AI’s new class of multimodal foundation models built for unprecedented speed, quality, and efficiency. We’ll explore how LFM2’s novel hybrid Liquid architecture - combining gated short-range convolutions and grouped attention - delivers large-model quality at mobile-class speed across language, vision, and audio. Optimized for CPUs, GPUs, and NPUs across phones, cars, and robots, LFM2 redefines what’s possible for real-time, private, and cost-efficient generative AI at the edge.',
