...
// },
{
    ...
    img: 'sreeram.jpeg',
    type: 'Keynote',
    title: 'Analogies and their power in creativity',
    abstact: 'Analogies are powerful tools. some Nobel-prizes have been won by scientists who started with Analogies. Maxwell developed his equations in electromagnetics by using analogs  to fluid flow. In this talk, as an example, I will illustrate the power of analogies between millions of people running, back and forth in circles and the development of MR imaging. Various aspects of MRI will be related to this simple analogy. The genesis of this analogy came from Sir Peter Mansfield, who later won the Nobel, for the creation of the first live image of a human body part using MRI. The key to using analogies is by strating with a simple model and thenexpanding it as necessary.',
...
{
    name: 'Riddhiben Shah',
    affiliation: 'Senior Software Engineer at Vicor',
    img: 'riddhiben_shah.PNG',
    type: 'Panelist',
    title: 'Women in STEM',
    abstact: '',
