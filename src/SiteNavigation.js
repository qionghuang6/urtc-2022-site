...
const pageMap = { 'URTC 2022': '/urtc-2022', 'About': '/about', 'Submission': '/submission', 'Sponsorship': '/sponsorship', 'Resources': '/resources', 'Contact Us': '/contact' };
...
export default function SiteNavigation() {
    ...
    return (
      <AppBar position="static" sx={{
        backgroundColor: 'rgba(68, 23, 68, 0.4)'
      }}>
